...
function Sidebar({ setOpen,open }) {
    ...
    return (
        <div style={{transform: `translateX(${open ? '0' : '-100%'})`}} className='border-1 h-screen z-[999] sticky top-[0%] left-[0%] w-[90vw] bg-white flex flex-col justify-start items-start p-5'>
