...
export default function Home() {
  ...
  const cards = [
    { id: 1, content: 'Professional tutors, tailored lessons, and significant progress. Great support for challenging subjects.', author: 'John Welberg' },
    { id: 2, content: 'Engaging sessions, flexible scheduling, and knowledgeable instructors. Excellent value for boosting grades.', author: 'Tom Jeferd' },
    { id: 3, content: 'Exceptional tutors, personalized attention, and noticeable improvement. Highly recommend for academic success.', author: 'Grise Ediese' },
  ...
  const Courses = [
    ...
    {
      img: "https://th.bing.com/th/id/OIP.UpgpHc-ZzXLJREotRpnjCwAAAA?rs=1&pid=ImgDetMain",
      title: "Digital marketing",
    },
    {
      img: "https://th.bing.com/th/id/OIP.UHfomHEzOKRy-VrE2Se5IwHaEK?rs=1&pid=ImgDetMain",
      title: "Data Analyst",
    }
  ];
  ...
  return (
    <main className="flex h-screen w-screen flex-col bg-white lg:px-[100px] ">
        ...
        <div className="flex flex-col">
          <div className="flex px-5 pt-[45px] items-start lg:flex-row md:flex-row sm:flex-row s:flex-col-reverse">
            <div className="flex flex-col lg:w-[50%] md:w-[50%] sm:w-[50%] s:w-[100%] mb-16 items-start mt-[30px]">
              <h1 className="lg:text-5xl md:text-5xl sm:text-4xl s:text-3xl text-start font-extrabold mb-4 text-gray-900">We provide
                <br className="" />Smart & Letest Industry
                <br className="" />Courses for all
              </h1>
              <p className="mb-8 text-[14px] w-[80%]">With our Courses you can learn a latest technology and skills at your home.</p>
              <div className="flex justify-start">
                <div className="lg:p-[10px] md:p-[10px] sm:p-[10px] bg-[#F3F4FF] rounded-[10px] gap-[4px] flex justify-center items-center s:p-[2px]">
                  <SearchIcon />
                  <input className="outline-none text-gray bg-[#F3F4FF]" placeholder="Search Courses" />
          ...
          <div className="container mx-auto flex lg:px-5 lg:py-24 md:px-5 md:py-24 sm:px-5 sm:py-24 s:px-5 s:py-0  md:flex-row flex-col items-center lg:flex-row md:flex-row sm:flex-row s:flex-col-reverse">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-start">
              <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Our Courses are certified
                <br className="hidden lg:inline-block" /> and tested by reputated Instituites
              </h1>
              <p className="mb-8 leading-relaxed">We also privide a placement preparation to our students for land their dream jobs.</p>
          ...
          <div className="container mx-auto lg:px-5 lg:py-24 md:px-5 md:py-24 sm:px-5 sm:py-24 s:px-5 s:py-0">
            <div className="flex flex-col lg:text-center md:text-center sm:text-center s:text-start w-full mb-20">
              <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">We have a Vast Variety of Courses</h1>
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base">We focus on the basics and help to students to build a foundation of learning. So they can make bright thier Future.</p>
            </div>
          ...
          <div className="container mx-auto flex lg:px-5 lg:py-24 md:px-5 md:py-24 sm:px-5 sm:py-24 s:px-5 s:py-0 md:flex-row flex-col items-center">
            ...
            <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-start">
              <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">1:1 Doubt Sessions Provided
                <br className="hidden lg:inline-block" />Because We Care About Our Students
              </h1>
              <p className="mb-8 leading-relaxed">Student will be studied in the guidence of personalized teachers and will provided a mentorship</p>
              <div className="flex justify-center">
                <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Know More</button>
              </div>
            </div>
          ...
          <div className="container mx-auto lg:px-5 lg:py-24 md:px-5 md:py-24 sm:px-5 sm:py-24 s:px-0 s:py-5">
            <div className="flex justify-between w-full mb-20 lg:flex-row md:flex-row sm:flex-row s:flex-col lg:text-start md:text-start sm:text-start s:text-center gap-[20px]">
              <div className="flex flex-col lg:text-start md:text-start sm:text-start s:text-center">
                <h3 className="text-[30px] font-[600]">Our Courses</h3>
                <p className="">These are the Courses you'll get to learn which are built with lot's of love and dedication</p>
              </div>
              <div>
            ...
            <div className="flex w-full justify-center items-center lg:flex-row md:flex-row sm:flex-row s:flex-col">
              <div className="scroll-container flex w-[100%] lg:gap-[40px] md:gap-[40px] sm:gap-[40px] s:gap-[10px] items-center lg:justify-center md:justify-center sm:justify-center s:justify-start overflow-x-auto whitespace-nowrap">
                {Courses.map((item, index) => (
                  <div key={index} className="break-words p-5 gap-[20px] w-[300px] rounded-[5px] border-2 border-gray-300 flex flex-col">
                    <img src={item.img} className="h-[170px] w-[100%] rounded-[4px]" />
                    <div className="flex flex-col gap-[10px]">
                    <p className="font-medium ">{item.title}</p>
                    <p className="text-gray-500 text-[14px]">Beginner to Advance</p>
      ...
      <div className="w-[100%] flex justify-center items-center font-medium text-3xl"><h2>Why Join Itutor?</h2></div>
          <div className="container mx-auto flex lg:px-5 lg:py-24 md:px-3 md:py-24 sm:px-5 sm:py-24 s:px-5 s:py-0 md:flex-row flex-col items-center">
            <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
              <img className="object-cover object-center rounded lg:mt-0 md:mt-0 sm:mt-0 s:mt-10 lg:h-[600px]" alt="hero" src="Img/boy studing.png" />
            </div>
            <div className=" lg:ml-[100px] md:ml-[100px] sm:ml-[0px] s:ml-[0px]">
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Expert Tutors:</h2>
                  <p className="leading-relaxed">Learn from highly qualified and experienced instructors who are passionate about teaching and dedicated to your success.</p>
                </div>
              </div>
              <div className="flex relative pb-12">
                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                ...
                <div className="flex-grow pl-4">
                  <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Flexible Learning:</h2>
                  <p className="leading-relaxed">Access a wide range of courses anytime, anywhere, allowing you to learn at your own pace and on your own schedule.</p>
                </div>
              </div>
              <div className="flex relative pb-12">
                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                ...
                <div className="flex-grow pl-4">
                  <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Placement Preparation:</h2>
                  <p className="leading-relaxed">Benefit from a well-rounded curriculum that covers various subjects and skill levels, ensuring a thorough understanding of each topic.</p>
                </div>
              </div>
              <div className="flex relative pb-12">
                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                ...
                <div className="flex-grow pl-4">
                  <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Interactive Learning Experience:</h2>
                  <p className="leading-relaxed">Engage in dynamic and interactive lessons that include quizzes, assignments, and live sessions to enhance your learning experience.</p>
                </div>
              </div>
              <div className="flex relative">
                ...
                <div className="flex-grow pl-4">
                  <h2 className="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Personalized Support: </h2>
                  <p className="leading-relaxed"> Receive individualized attention and support through one-on-one tutoring sessions, progress tracking, and tailored feedback to help you achieve your academic goals.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:mt-[40px] md:mt-[40px] sm:mt-[50px] s:mt-[60px]">
            <div className="w-full flex lg:flex-row md:flex-row sm:flex-row s:flex-col">
              <div className="lg:flex-1 md:flex-1 sm:flex-1 s:w-full lg:mb-0 md:mb-0 sm:mb-0 s:mb-5 ">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                  ...
                  <p className="mt-2 text-sm text-gray-500">Unlock Your Potential with Itutor.<br />
                    Your Gateway to Expert Course Tuition!
                  </p>
                </div>
              </div>

              <div className="cursor-pointer flex justify-around lg:flex-2 md:flex-2 sm:flex-2 s:w-full lg:flex-nowrap md:flex-nowrap sm:flex-nowrap s:flex-wrap gap-[30px] ">
                <div className="">
                  <nav className="list-none mb-10">
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">About</a>
                    </li>
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Services</a>
                    </li>
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">What We Provide</a>
                    </li>
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Blog</a>
                    </li>
                  </nav>
                </div>
                <div className="">
                  <h2 className="title-font font-medium text-gray-900"></h2>
                  <nav className="list-none mb-10">
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Terms</a>
                    </li>
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Privacy</a>
                    </li>
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Community</a>
                    </li>
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Forum</a>
                    </li>
                  </nav>
                </div>
                <div className="">
                  ...
                  <nav className="list-none mb-10">
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Accessibility</a>
                    </li>
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Help</a>
                    </li>
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Become a Partner</a>
                    </li>
                    <li>
                      <a className="cursor-pointer text-gray-600 hover:text-gray-800">Careers</a>
                    </li>
                  </nav>
                </div>
              </div>
            ...
            <div className="bg-gray-100">
              <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 — Ituitor
                  <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@arjunrathod</a>
                </p>
